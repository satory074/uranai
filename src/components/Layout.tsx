...
export function Layout() {
  return (
    <div className="min-h-screen flex flex-col pb-[calc(48px+env(safe-area-inset-bottom))]">
      ...
      <nav
        ...
        className="app-backlink-bar fixed inset-x-0 bottom-0 z-40 border-t border-border-hairline bg-paper/90 backdrop-blur"
